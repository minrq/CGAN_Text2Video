...
img_gif_dir = path.join(out_dir, 'paperfig_longsequence', 'img_gif')
img_all_dir = path.join(out_dir, 'paperfig_longsequence', 'img_all')
frame_dir = path.join(out_dir, 'paperfig_longsequence', 'frames')
