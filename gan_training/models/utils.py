...
def prepare_parser():
  ...
  parser.add_argument('--hybrid_noisy', action='store_true')
  ...
  parser.add_argument('--concat_output', action='store_true')
  parser.add_argument('--use_torch_SN', action='store_true')
  parser.add_argument('--remove_unused_computation', action='store_true')
  parser.add_argument('--add_unused_computation', action='store_true')
  parser.add_argument('--fc_debug_loss_type', type=str, default='fc')
  parser.add_argument('--tied_weights', action='store_true')
  parser.add_argument('--enable_duplicated_T', action='store_true')
  ...
  parser.add_argument('--adaptive_gen_loss_detach', action='store_true')
  ...
  # parser.add_argument('--log_sigma_no_sn', action='store_true')
  ...
  # parser.add_argument('--no_use_torch', action='store_false', dest='use_torch', default=True,
  ...
  ### Model stuff ###
  parser.add_argument(
    '--model', type=str, default='BigfcGAN',
...
def append_npy(filename, item):
  if os.path.exists(filename):
    ...
    arr = np.concatenate([arr, [float(item)]])
  else:
    arr = [float(item)]
