...
class TextEncoder(nn.Module):
    ...
    def forward(self, x):
        ...
        c_filt = torch.cat((c_filt_L1[:, 0:int(self.out_filt/2), :, :, :], c_filt_L2[:, 0:int(self.out_filt/2), :, :, :], c_filt_L1[:, int(self.out_filt/2):, :, :, :], c_filt_L2[:, int(self.out_filt/2):, :, :, :]), dim=1)
        ...
        m_filt = torch.cat((m_filt_L1[:, 0:int(self.out_filt/2), :, :, :], m_filt_L2[:, 0:int(self.out_filt/2), :, :, :], m_filt_L1[:, int(self.out_filt/2):, :, :, :], m_filt_L2[:, int(self.out_filt/2):, :, :, :]), dim=1)
